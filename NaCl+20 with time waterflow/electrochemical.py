...
def compute_ecd_fluxes (cell,jvol):
	...
	# local variables
	dmu = np.zeros([NS,NC])
	if cell.segment == 'PT' or cell.segment == 'S3' or cell.segment =='SDL' or cell.segment == 'mTAL' or cell.segment == 'cTAL' or cell.segment == 'MD' or cell.segment == 'DCT' or cell.segment == 'IMCD':
		crange=[0,1,4,5]
	...
	for i in range(NS):
		for k in crange:
			for l in crange[crange.index(k):]:
				...
				# 	if k == 1:
				# 		if l == 4:
				# 			print(cell.area[k,l],cell.h[i,k,l],cell.conc[i,k],cell.conc[i,l])
				# 			print(XI,jsol[i,k,l])
				...
				# 	if k == 1:
				# 		if l == 4:
				# 			print(concdiff,concmean,jsol[i,k,l])
				# 			print(dimless,convect,cell.sig[i,k,l],jvol[k,l])
