...
cell=np.loadtxt(file)
plt.figure()
plt.plot(10000*cell[1], label="cell 1")
plt.plot(10000*cell[50], label="cell 50")
plt.plot(10000*cell[100], label="cell 100")
plt.plot(10000*cell[150], label="cell 150")
plt.plot(10000*cell[200], label="cell 200")
plt.title('lumen waterflow oscillation')
plt.legend(loc="upper right")
plt.xlabel("time(s)")
plt.ylabel("lumen water flow(nL/min)")
...
for s in range(15):
    ...
    for i in range(Ncell):
        for j in range(N):
            cell[i][j] = cell1[i][j]*cell2[i][j]
    plt.figure()
    plt.plot(10*cell[1] , label="cell 1")
    plt.plot( 10*cell[50], label="cell 50")
    plt.plot( 10*cell[100] , label="cell 100")
    plt.plot( 10*cell[150] , label="cell 150")
    plt.plot(10*cell[200] , label="cell 200")
    plt.title('lumen ' + solute[s] + ' flow oscillation')
    plt.legend(loc="upper right")
    plt.xlabel("time(s)")
    plt.ylabel("lumen "+solute[s]+" solute flow(nM/min)")
...
for s in range(15):
    ...
    cell = np.loadtxt(filename).reshape(Ncell, N)
    plt.figure()
    plt.plot(cell[1:N, 0], label="time 0")
    plt.plot(cell[1:N, 2], label="time 2")
    plt.plot(cell[1:N, 4], label="time 4")
    plt.plot(cell[1:N, 6], label="time 6")
    plt.plot(cell[1:N, 8], label="time 8")
